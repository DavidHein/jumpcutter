...
def createPath(s):
    ...
    try:
        ...
        assert (
            False
        ), "Creation of the directory %s failed. (The TEMP folder may already exist. Delete or rename it, and try again.)"
...
for chunk in chunks:
    audioChunk = audioData[
        int(chunk[0] * samplesPerFrame) : int(chunk[1] * samplesPerFrame)
    ]
    ...
    if leng < AUDIO_FADE_ENVELOPE_SIZE:
        outputAudioData[outputPointer:endPointer] = (
